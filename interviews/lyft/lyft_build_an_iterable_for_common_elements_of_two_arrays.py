"""
    ...
    Given two arrays, design an iterable-like object that has two functions: 1) next 2)has_next
    
    1) next()
    return the next common element in the two arrays
    
    2) has_next()
    return T/F whether there is still common element in the two arrays
